(function () {
	...
	let new_height = parameters.height;
	...
	switch (type) {														// Set XY scaling values for mesh files based on payload class  
		case 0:
			XY_scale = 0.632;
	...
	let createJoints = function () {									// URDF code to create joints 
	...
	let createLinks = function () {										// URDF code to create links 
